...
const steps = [
  {
    ...
    body: 'Cold email only works if you reach someone who has the problem you solve. We find it exactly.',
  },
  {
    num: '02',
    title: 'The right person.',
    body: 'Title, company stage, buying signal. Specificity is what makes replies happen.',
  },
  {
    num: '03',
    title: 'The right angle.',
    body: 'Four offer frames go out. The one with replies gets scaled.',
  },
]
    ...
    <section className="bg-background py-24 lg:py-32">
      <div className="max-w-5xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          >
            Three things we test before anything scales.
          </motion.h2>
